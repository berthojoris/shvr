            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ba_post') }}">
                        ...
                        <div class="form-group row">
                            <label for="full_name" class="col-md-7 col-form-label text-md-left">Nama Lengkap</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="instagram" class="col-md-7 col-form-label text-md-left">Instagram</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-7 col-form-label text-md-left">HP / Telp</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="gender" class="col-md-7 col-form-label text-md-left">Jenis Kelamin</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="address" class="col-md-7 col-form-label text-md-left">Alamat Lengkap</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="province" class="col-md-7 col-form-label text-md-left">Provinsi</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="city" class="col-md-7 col-form-label text-md-left">Kota</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="postal_code" class="col-md-7 col-form-label text-md-left">Kode Pos</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="job" class="col-md-7 col-form-label text-md-left">Pekerjaan</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_1" class="col-md-7 col-form-label text-md-left">Kamu mengetahui acara ini dari siapa?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_2" class="col-md-7 col-form-label text-md-left">Apakah kamu tertarik menjadi brand ambassador GG SHVR?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_3" class="col-md-7 col-form-label text-md-left">Apakah kamu suka datang ke acara party/clubbing?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_4" class="col-md-7 col-form-label text-md-left">Apakah kamu merokok?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_5" class="col-md-7 col-form-label text-md-left">Apakah kamu mengetahui & menggunakan produk GG SHVR?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_6" class="col-md-7 col-form-label text-md-left">Berapa kali kamu biasanya hangout/party dalam sebulan</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_7" class="col-md-7 col-form-label text-md-left">Sebutkan tempat hangout/party di kota kalian yg biasa kalian kunjungi</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_8" class="col-md-7 col-form-label text-md-left">Sebutkan 5 nama Local DJ favorit kalian</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_9" class="col-md-7 col-form-label text-md-left">Sebutkan 5 nama International DJ favorit kalian</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_10" class="col-md-7 col-form-label text-md-left">Produk rokok apa yang kamu konsumsi sekarang ini?</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_11" class="col-md-7 col-form-label text-md-left">Tuliskan secara singkat profil diri kamu</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_12" class="col-md-7 col-form-label text-md-left">Tuliskan secara singkat alasan kamu, kenapa kamu tertarik ingin menjadi brand ambassador GG SHVR</label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group row">
                            <label for="question_13" class="col-md-7 col-form-label text-md-left">Kalau kamu terpilih sebagai brand ambassador GG SHVR, apa yang akan kamu lakukan untuk menaikan brand GG SHVR</label>
                            <div class="col-md-5">
